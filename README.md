...
> [!WARNING]
> Never commit service-account JSON files, private keys, signing keystores, passwords, or `.env` files to Git or Flutter assets. Service-account keys belong on a trusted backend, never inside a mobile app.
