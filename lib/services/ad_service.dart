...
class AdService {
  ...
  // Test ID-ləri
  final String _testBannerAdUnitId = Platform.isAndroid ? 'ca-app-pub-3940256099942544/6300978111' : 'ca-app-pub-3940256099942544/2934735716';

  final String _testInterstitialAdUnitId = Platform.isAndroid ? 'ca-app-pub-3940256099942544/1033173712' : 'ca-app-pub-3940256099942544/4411468910';
  ...
  final String _realBannerAdUnitId = Platform.isAndroid ? 'ca-app-pub-XXXXXXXXXXXXXXXX/XXXXXXXXXX' : 'ca-app-pub-XXXXXXXXXXXXXXXX/XXXXXXXXXX';
    ...
    if (_isInterstitialAdReady && _interstitialAd != null) {
      _interstitialAd!.fullScreenContentCallback = FullScreenContentCallback(
        onAdDismissedFullScreenContent: (ad) {
          ...
          loadInterstitialAd(); // Yeni reklam yüklə
          onAdClosed?.call(); // Callback-i çağır
        },
        onAdFailedToShowFullScreenContent: (ad, error) {
          ad.dispose();
          _interstitialAd = null;
          loadInterstitialAd();
          onAdClosed?.call(); // Xəta halında da callback-i çağır
        },
      );
      _interstitialAd!.show();
    } else {
      // Əgər reklam yoxdursa, dərhal callback-i çağır
      onAdClosed?.call();
    }
  }
